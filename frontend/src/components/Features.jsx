...
const Features = () => {
  return (
    <section className='max-padd-container py-16'>
      <div className='max-padd-container grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4
      gap-5 gap-y-12'>
        <div className='flexCenter flex-col gap-3'>
          <img src={filter}  height={44} alt="" width={44} />
          <div className='flexCenter flex-col'>
            <h5 className='h5'>Advanced Search and Filtering</h5>
        ...
        <div className='flexCenter flex-col gap-3'>
          <img src={rating}  height={44} alt="" width={44} />
          <div className='flexCenter flex-col'>
        ...
        <div className='flexCenter flex-col gap-3'>
          <img src={wishlist}  height={44} alt="" width={44} />
          <div className='flexCenter flex-col'>
            <h5 className='h5'>Wishlist and Favourites</h5>
            <hr className='w-8 bg-secondary h-1 rounded-full border-none' />
        ...
        <div className='flexCenter flex-col gap-3'>
          <img src={secure}  height={44} alt="" width={44} />
          <div className='flexCenter flex-col'>
            <h5 className='h5'>Secure Online Payments</h5>
            <hr className='w-8 bg-secondary h-1 rounded-full border-none' />

          </div>
          <p className='text-center'>Enjoy seamless checkout with multiple secure payment processes</p>
        </div>
      </div>
    </section>
  )
