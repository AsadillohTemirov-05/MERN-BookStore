...
const Shop = () => {
  ...
  const [sortType, setSortyType] = useState("relevant");
    ...
    <section className='max-padd-container bg-white'>
      <div className='pt-28'>
        ...
        <div className='w-full max-w-2xl flexCenter '>
          <div className='inline-flex items-center justify-center bg-primary overflow-hidden
            w-full rounded-full p-4 px-5'>
        ...
        <div className='mt-8'>
          <div className='flexBetween !items-start gap-7 flex-wrap pb-16 max-sm:flexCenter text-center'>
            ...
            <div className='flexCenter gap-x-2'>
              ...
              <select
                onChange={(e) => setSortyType(e.target.value)}
        ...
        <div className='flexCenter mt-14 mb-10 gap-4'>
          ...
          {Array.from({ length: totalPages }, (_, index) => (
            <button
              key={index + 1}
              className={`btn-light !px-3 !py-1 ${currentPage === index + 1 ? "!bg-secondaryOne" : ""}`}
